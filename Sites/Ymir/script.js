// ===== CONFIGURÁVEIS ===== //
// AGORA EDITE NO ARQUIVO config-precos.js !
// Carrega configuração do arquivo externo
const YMIR_CFG = window.YMIR_CONFIG || { exchangeRate: 5.88, CONFIG_PACOTES: [] };

const CONFIG_PACOTES = YMIR_CFG.CONFIG_PACOTES.length > 0 ? YMIR_CFG.CONFIG_PACOTES : [
